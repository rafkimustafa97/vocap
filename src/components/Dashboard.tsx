  ...
  return (
    <div className="space-y-6 pb-24 max-w-2xl mx-auto px-2">
      ...
      <div className="bg-white rounded-[32px] p-6 shadow-sm border border-slate-100 space-y-4">
          ...
          <div className="flex items-center gap-5">
            ...
            <div className="relative w-24 h-24 shrink-0 flex items-center justify-center">
              ...
              <div className="absolute inset-0 flex flex-col items-center justify-center">
                ...
                <span className="text-[9px] text-slate-400 font-extrabold uppercase tracking-wider">PTE Ready</span>
              </div>
            </div>

            <div>
              <span className="bg-blue-100 text-blue-700 text-[10px] font-black px-2.5 py-0.5 rounded-full uppercase tracking-widest">
                Lumina Learn Command Center
              </span>
              <h2 className="text-xl md:text-2xl font-black text-slate-900 mt-1 tracking-tight">PTE Readiness Index</h2>
        ...
        {/* WEEKLY PERFORMANCE METER BAR (GAMBAR 1 HIGHLIGHTED RED BOX) */}
        <div className="pt-3 border-t border-slate-100 space-y-1.5">
          <div className="flex justify-between items-center text-xs font-extrabold">
            <span className="flex items-center gap-1.5 text-slate-800">
              <TrendingUp className="w-4 h-4 text-blue-600" /> Performa Hafalan Minggu Ini:
            </span>
      ...
      {dayType === 'review' && (
        <div className="bg-gradient-to-r from-orange-500 to-amber-600 rounded-3xl p-5 text-white shadow-lg shadow-orange-500/20">
          <div className="flex items-start gap-3">
            <div className="p-2 bg-white/20 rounded-2xl shrink-0">
              <RotateCcw className="w-6 h-6 text-white" />
            </div>
            <div className="flex-1">
              <h3 className="font-extrabold text-base">HARI SABTU: MANDATORY VOCABULARY REVIEW</h3>
      ...
      {dayType === 'rest' && (
        <div className="bg-emerald-600 rounded-3xl p-5 text-white shadow-lg shadow-emerald-500/20 flex items-center gap-4">
          <div className="p-3 bg-white/20 rounded-2xl shrink-0">
            <Coffee className="w-8 h-8 text-white" />
          </div>
          <div>
            <h3 className="font-extrabold text-base">MINGGU: REST & RECOVERY DAY ☕</h3>
      ...
      <div className="bg-blue-600 rounded-[36px] p-7 md:p-8 text-white shadow-xl shadow-blue-500/25 relative overflow-hidden">
        ...
        <div className="relative z-10 space-y-4">
          <div className="flex justify-between items-center">
            <span className="bg-blue-500/50 text-white text-xs font-extrabold px-4 py-1.5 rounded-full flex items-center gap-1.5 tracking-wide">
          ...
          <div>
            ...
            <h3 className="text-3xl md:text-4xl font-black mt-1 tracking-tight">
          ...
          <div className="pt-3 flex flex-col sm:flex-row gap-3">
            <button
              ...
              className="flex-1 bg-white text-blue-600 font-black py-4 px-6 rounded-2xl shadow-[0_4px_0_#d1d5db] active:translate-y-0.5 transition-all flex items-center justify-center gap-2 text-sm md:text-base"
            >
            ...
            <button
              ...
              className="bg-blue-800/80 hover:bg-blue-800 text-white font-bold py-4 px-5 rounded-2xl border border-blue-400/30 active:scale-95 transition-all flex items-center justify-center gap-2 text-sm"
            >
          ...
          <div className="bg-blue-700/50 border border-blue-400/30 rounded-2xl p-3 flex items-start gap-2 text-xs text-blue-100 mt-2">
            <span className="font-black text-amber-300 text-sm leading-none">!</span>
      ...
      <div className="bg-white rounded-[32px] p-6 border border-slate-100 shadow-sm space-y-3">
        <div className="flex justify-between items-center">
          <h3 className="font-extrabold text-slate-800 text-sm md:text-base uppercase tracking-wider">Weekly Schedule Tracker</h3>
          ...
          {['Sen', 'Sel', 'Rab', 'Kam', 'Jum', 'Sab', 'Min'].map((dayName, idx) => {
            ...
            return (
              <div key={idx} className="flex flex-col gap-1.5">
                <span className="text-[10px] text-slate-400 font-black uppercase tracking-wider">{dayName}</span>
                <div
                  className={`h-12 rounded-2xl flex flex-col items-center justify-center font-extrabold text-xs transition-all ${
                    isToday
      ...
      <div className="bg-white rounded-[32px] p-6 border border-slate-200 shadow-sm space-y-4">
        <div className="flex justify-between items-center">
          <div className="flex items-center gap-2.5">
            ...
            <h3 className="font-extrabold text-slate-800 text-sm md:text-base">Weakness Radar (4-Tier)</h3>
          </div>
